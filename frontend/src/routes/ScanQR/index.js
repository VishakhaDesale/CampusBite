...
export default function ScanQRPage() {
  ...
  //   const pdata = {
  //     secret: "kvil", // 4-character secret matching user's record
  //     email: "lufyzoro2003@gmail.com",
  //     day: "sunday", // Current day in lowercase
  //     type: "breakfast",
  //   };
//   const pdata1 = "kvillufyzoro2003@gmail.com";
  ...
  useEffect(() => {
    ...
    console.log("type change", secret, email, day);
    ...
    <>
      ...
      <div className={classes.body}>
        <Card className={classes.card}>
          ...
          {type ? <h1>Scan QR Code for {type}</h1> : <h1>Select the meal</h1>}
          <motion.div layout>
            {type ? (
              <Fade
                one2Two={valid === null}
                one={<LoadingOutlined className={classes.icon} />}
                two={
                  <Fade
                    one2Two={!valid}
                    one={<CloseSquareOutlined className={classes.icon} />}
                    two={<CheckSquareOutlined className={classes.icon} />}
                  />
                }
              />
            ) : null}
